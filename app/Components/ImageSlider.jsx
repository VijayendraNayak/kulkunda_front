...
const ImageSlider = () => {
  ...
  return (
    <div className='relative flex h-[600px] sm:h-[500px] w-full flex-col mt-12 sm:mt-26 sm:justify-center items-center'>
      <div className='relative w-full h-[600px] sm:h-[500px] flex overflow-hidden'>
