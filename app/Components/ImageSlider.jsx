...
const ImageSlider = () => {
  ...
  return (
    <div className='relative flex h-[500px] sm:h-[400px] w-full flex-col mt-12 sm:mt-26 sm:justify-center items-center'>
      <div className='relative w-full h-[500px] sm:h-[400px] flex overflow-hidden'>
